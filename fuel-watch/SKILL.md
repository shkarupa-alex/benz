...
- `лимит: N л` в строке станции — минимальный известный лимит на АИ-95 среди ещё не протухших наблюдений (устаревшие отбрасываются, иначе самое старое и самое маленькое значение выигрывало бы минимум). Если у лимита есть время и оно уже не свежее, рядом печатается возраст: `лимит: 20 л (3 ч назад)`. Это ограничение поездки, а не признак наличия.
