...
- `лимит: N л` в строке станции — минимальный известный лимит на АИ-95 по всем источникам. Это ограничение поездки, а не признак наличия.
